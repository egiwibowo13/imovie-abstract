#
#  Be sure to run `pod spec lint Abstract.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/egiwibowo13/imovie-abstract.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Abstract/**/*.{h,m,swift}"
